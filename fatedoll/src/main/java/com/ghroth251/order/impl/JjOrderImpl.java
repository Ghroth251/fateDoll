...
import static com.ghroth251.util.MechaUtils.*;
import static com.ghroth251.util.StaticObjectUtils.mSv;
...
public class JjOrderImpl {
    ...
    public static String upmecha(QQuser u, String value) {
        ...
        if(oldMecha!=null){
            ...
            sbd.append(mSv.updateMecha(mecha)==null?"更新失败":
    ...
    public static String umecha(QQuser u) {
        ...
        if (mecha == null) {
            ...
            mecha.setUid(null);
            sbd.append(mSv.updateMecha(mecha) == null ? "操作失败" : "成功与" +
                    mecha.getMname() + "解除绑定");
        }
        return ( sbd.toString());
    }
    public static String atk(QQuser u, String value, String ordinal) {
        ...
        if (ordinal != null) {
            ...
            if (weaponName.toCharArray()[0] > '9') {
                ...
                weaponData[1] = mecha.getLWeapon1Data();
                weaponData[2] = mecha.getLWeapon2Data();
                weaponData[3] = mecha.getLWeapon3Data();
                weaponData[4] = mecha.getLWeapon4Data();
    ...
    public static String addm(QQuser u, String value, QQuser target) {
        StringBuilder sbd = new StringBuilder();
        if(!(u.getUserID()==553859318)&&target==null){
            sbd.append("您没有权限这么做");
        }else if(value!=null){
            Mecha mecha = generateMecha(value);
            if(target!=null){
            ...
            sbd.append(mSv.addMecha(mecha)==null?"添加失败":"已添加机甲："+mecha.getMname());
        }else{
