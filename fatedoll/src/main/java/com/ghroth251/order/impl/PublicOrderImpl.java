...
public class PublicOrderImpl {
    ...
    public static String fnn(QQuser u, String value) {
        ...
        if(value!=null){
            ...
            return (u.getUserOldName()+"更改名字为："+u.getUserName());
        }else{
    ...
    public static String fate(QQuser u, String value, String skill) {
        ...
        if (value != null) {
            ...
            return (FateRoll(u.getUserName(),num,sent,skill));
        }else{
            return (FateRoll(u.getUserName(),0, null,skill));
        }
    }
    public static String fon(QQuser u, String value) {
        if(value!=null&&u.getUserID()==553859318&&value.equals(myDice.getCode())){
            fateState = true;
            return (myDice.getName()+"已开启");
        }else{
            return ("你没有权限这么做");
        }
    }
    ...
    public static String addPC(QQuser u, String value) {
        ...
        if(value!=null&&u.getUserID()==553859318){
            value = reAllSpace(value);
            QQuser u2 = uSv.getUserByUser(new QQuser(Integer.parseInt(value), u.getUsergroup()));
