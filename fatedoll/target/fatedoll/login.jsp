...
<head>
    ...
    <script type="text/javascript">
        ...
        function changeImage() {
            document.getElementById("img").src="${pageContext.request.contextPath}/createImg?date="+new Date();
        }
    ...
    <div class="main clearfix">
        <div class="logbox">
            <div class="header" style="background-color: #2468a9;">
                骰子姬web页面 <span style="color: red">${message}</span>
            </div>
            <div class="web_login" id="web_login">
                <form id="loginform"  name="loginform" action="${pageContext.request.contextPath}/page/list" method="post">
